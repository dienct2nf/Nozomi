...
@endif
    {!! Form::open(['route' =>  ['album.update', $album->id], 'files' => true]) !!}
    {{ method_field('PUT') }}
        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="showthumb">
                                                    ...
                                                    <div id="lfm" data-input="thumbnail" data-preview="holder">
                                                        <img id="holder" class="showthumb--beautifull" src="{{ !is_null($album->img)? '/uploads/'.$album->img : \setting('noimage') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="img-grid">
                                        ...
                                        @foreach ($data->media as $row)
                                            <div id="{{  $row->id }}" class="album">
                                                <img src="/uploads/{{  $row->getDiskPath() }}" style="max-height: 200px; max-width: 200px; overflow: hidden; object-fit: cover;">
                                                <span data-url="/admin/album/delete/{{  $row->id }}" data-id="{{  $row->id }}" class="delete-thumb-album" title="xóa hình ảnh"><i class="fas fa-minus-circle"></i></span>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
