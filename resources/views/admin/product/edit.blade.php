...
@section('title', __('label.edit_product'))
...
@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('label.edit_product') }}</li>
        </ol>
    </nav>
@stop
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text("date",
                                        old("date") ? old("date") : (!empty($product) ? date('d-m-Y', strtotime($product->date)) : null),
                                        [
                        ...
                        <div class="form-group">
                            ...
                            <div class="showthumb">
                                ...
                                <div id="lfm" data-input="thumbnail" data-preview="holder">
                                    <img id="holder" class="showthumb--beautifull" src="{{ !is_null($product->img)? '/uploads/'.$product->img : \setting('noimage') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" id="top" name="top" {{ $product->top == 1 ? 'checked="checked"' : '' }}>
