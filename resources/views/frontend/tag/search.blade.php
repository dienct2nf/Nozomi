...
@section('keywords', str_replace(' ', ' ,', $key))
@section('img', \setting('thumbnail'))
@section('url', url('/search?s='.$key))
@section('content')
                                    ...
                                    <div class="block block-system block-system-main-block no-title">
                                        <div class="content block-content">
                                            <div class="views-element-container">
                                                <div class="post-style-list">
                                                    <div class="item-list">
                                                        <ul>
                                                            ...
                                                            @endif
                                                            @foreach ($post->paginate(5) as $item)
                                                                            ...
                                                                            <div class="post-block">
                                                                                <div class="post-image">
                                                                                    <img src="{{ !is_null($item->img)? '/uploads/'.$item->img : setting('thumbnail') }}" alt="" typeof="Image"></div> <div class="post-content">
                                                                                        ...
                                                                                        <div class="post-meta margin-bottom-10"><span class="post-created"> {{ date('d/m/Y', strtotime($item->created_at)) }} </span></div>
                                                ...
                                                {{ $post->paginate(5)->links('vendor.pagination.page') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
