                            ...
                            <div class="column-inner bg-size-cover ">
                                <div class="column-content-inner">
                                    <div class="widget gsc-heading align-center style-2 text-light ">
                                        <h2 class="title home-title_v1"><span class="white">{{ setting('section1_title') }}<br/>{{ setting('section1_desc') }}</span></h2>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                                    ...
                                    <div class="gsc-accordion" data-wow-delay="0.2s">
                                        <div class="views-element-container">
                                            <div class="post-list-small js-view-dom-id">
                                                <div class="item-list">
                                                    <ul>
                                                        @foreach ($listProductLeft as $item)
                                                            <li class="view-list-item">
                                                                <div class="views-field views-field-nothing">
                                                                    <div class="field-content">
                                                                        <div class="post-block">
                                                                            <div class="post-image">
                                                                                <a href="/don-hang/{{ $item->slug }}"><img class="lozad" data-src="{{ !is_null($item->img)? '/uploads/'.$item->img : \setting('thumbnail') }}" alt="{{ $item->name }}" typeof="Image"></a>
                                                                            </div>
                                                                            <div class="post-content">
                                                                                <div class="post-title"> <a href="/don-hang/{{ $item->slug }}" hreflang="vi">{{ $item->name }}</a> </div>
                                                                                <div class="post-meta"> <span class="post-created">{{ !empty($item->date_show_home_page) ? date('d/m/Y', strtotime($item->date_show_home_page)) : $item->created_at->format('d/m/Y') }} </span> </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="column-inner bg-size-cover ">
                                <div class="column-content-inner">
                                    <div>
                                        <div class="widget block clearfix gsc-block-view gsc-block-drupal block-view title-align-left text-dark remove-margin-off wow fade-up" data-wow-delay="0.3s">
                                            <div class="views-element-container">
                                                <div class="post-list-small js-view-dom-id">
                                                    <div class="item-list">
                                                        <ul>
                                                            @foreach ($listProductRight as $item)
                                                                <li class="view-list-item">
                                                                    <div class="views-field views-field-nothing">
                                                                        <div class="field-content">
                                                                            <div class="post-block">
                                        ...
                                        <div class="button-center"> <a href="{{ url('don-hang') }}" class="btn-theme">Xem thêm</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
