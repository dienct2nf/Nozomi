...
<nav class="navbar navbar-expand-md navbar-light bg-light">
    <a style="text-transform: uppercase" class="navbar-brand">Công việc {{ sw_get_current_weekday() }}</a>
    <a id="showDate" type="submit" class="btn btn-default btn-sm"><span class="fa fa-calendar"></span></a>
    @can('work-show')
        <a style="margin-left: 5px;" class="btn btn-info btn-sm" href="{{ route('work.worklist.create') }}"> <span class="fa fa-plus"></span></a>
    @endcan
            ...
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <input type="submit" name="submit" id="action_view" value="Xem" class="btn btn-info" />
                            ...
                            <li class="task-item">
                                <div class="panel-group wrap" id="accordion-{{$row->id}}" role="tablist"
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapse-{{$row->id}}" class="panel-collapse collapse in" role="tabpanel"
