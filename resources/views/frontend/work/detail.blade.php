...
<nav class="navbar navbar-expand-md navbar-light bg-light nav-todolist">
    ...
    <a style="margin-left: 5px;" href="/admin/work/department/showlist/{{ $department->id }}?ngaybatdau={{ date('d/m/Y') }}&ngayketthuc={{ date("d/m/Y") }}&date=today" type="submit" name="submit" class="btn btn-secondary btn-sm">HÔM NAY</a>
    <a style="margin-left: 5px;" href="/admin/work/department/showlist/{{ $department->id }}?ngaybatdau={{ \Carbon\Carbon::now()->startOfWeek()->format('d/m/Y') }}&ngayketthuc={{ \Carbon\Carbon::now()->endOfWeek()->format('d/m/Y') }}&date=week" type="submit" name="submit" class="btn btn-secondary btn-sm">TUẦN NÀY</a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav navbar-nav__color">
            <a style="text-transform: uppercase" class="nav-item nav-link" href="{{route('work.worklist.todoList')}}">Tất cả</a>
            @foreach ($listAllDepartmentSelect as $item)
                @if ($item->parent_id == null)
                    <a style="text-transform: uppercase" href="{{route('work.worklist.detailDepartment', $item->id)}}" class="nav-item nav-link {{ ($department->id == $item->id)? 'active': ''}}">{{ $item->title }}</a>
                @endif
            @endforeach
        </div>
        <div class="navbar-nav ml-auto">
            @can('work-show')
                <a style="margin-left: 5px;" class="btn btn-secondary btn-sm" href="{{ route('work.worklist.create') }}"> <span class="fa fa-plus"></span> Thêm</a>
                @else
            ...
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="/admin/work/department/showlist/{{$department->id}}?ngaybatdau={{ date('d/m/Y') }}&ngayketthuc={{ date("d/m/Y") }}&date=today" type="submit" name="submit" class="btn btn-info">HÔM NAY</a>
                        <a href="/admin/work/department/showlist/{{$department->id}}?ngaybatdau={{ \Carbon\Carbon::now()->startOfWeek()->format('d/m/Y') }}&ngayketthuc={{ \Carbon\Carbon::now()->endOfWeek()->format('d/m/Y') }}&date=week" type="submit" name="submit" class="btn btn-info">TUẦN NÀY</a>
                        <a href="/admin/work/department/showlist/{{$department->id}}?ngaybatdau={{ date('01/m/Y') }}&ngayketthuc={{ date("t/m/Y", strtotime(date('Y-m-d'))) }}&date=month" type="submit" name="submit" class="btn btn-info">THÁNG NÀY</a>
                ...
                <div class="card">
                    <div class="todo-wrapper">
                        <div class="todo-content">
                                ...
                                <div class="todo-header">
                                    ...
                                    @else
                                        @if (!empty(auth()->user()) && auth()->user()->department_id == $item->id)
                                            <div data-toggle="modal" data-target=".bd-example-modal-lg" class="add-circle" data-department_id="{{ $item->id }}">
                                                <i class="fa fa-plus"></i>
                                            </div>
                                        @endif
                                    @endcan
                            ...
                            <ul class="todo-list" style="height: 80vh !important; max-height: 80vh !important">
                                    ...
                                    <div class="panel-group wrap" id="accordion-{{$row->id}}" role="tablist"
                                        ...
                                        <div class="panel">
                                            <div role="tab" id="headingOne-{{$row->id}}">
                                                <div class="listwork" role="button" data-toggle="collapse" data-parent="#accordion-{{$row->id}}"
                                                    href="#collapse-{{$row->id}}" aria-expanded="true" aria-controls="collapse-{{$row->id}}">
                                            ...
                                            <div id="collapse-{{$row->id}}" class="panel-collapse in collapse show" role="tabpanel"
                                    ...
                                    <div class="panel-group wrap" id="accordion-{{$row->id}}-group" role="tablist"
                                        ...
                                        <div class="panel">
                                            <div role="tab" id="headingOne-{{$row->id}}-group">
                                                <div class="listwork pb" role="button" data-toggle="collapse" data-parent="#accordion-{{$row->id}}-group"
                                                    href="#collapse-{{$row->id}}-group" aria-expanded="true" aria-controls="collapse-{{$row->id}}-group">
                                            ...
                                            <div id="collapse-{{$row->id}}-group" class="panel-collapse in collapse show" role="tabpanel"
